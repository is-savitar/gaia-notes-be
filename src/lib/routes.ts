...
declare global {
    export type EdenRoutes = ElysiaWithBaseUrl<"/api/v1/", typeof Route0>
              & ElysiaWithBaseUrl<"/api/v1/profile", typeof Route1>
              & ElysiaWithBaseUrl<"/api/v1/auth/signup", typeof Route2>
              & ElysiaWithBaseUrl<"/api/v1/auth/logout", typeof Route3>
              & ElysiaWithBaseUrl<"/api/v1/auth/login", typeof Route4>
              & ElysiaWithBaseUrl<"/api/v1/auth/refresh-token", typeof Route5>
}